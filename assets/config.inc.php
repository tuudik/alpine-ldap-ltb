...
$ldap_starttls = getenv('LDAP_STARTTLS') ?: false;
...
$ad_mode = getenv('AD_MODE') ?: false;
# Force account unlock when password is changed
$ad_options['force_unlock'] = getenv('AD_OPTIONS_FORCE_UNLOCK') ?: false;
# Force user change password at next login
$ad_options['force_pwd_change'] = getenv('AD_OPTIONS_FORCE_PWD_CHANGE') ?: false;
# Allow user with expired password to change password
$ad_options['change_expired_password'] = getenv('AD_OPTIONS_CHANGE_EXPIRED_PASSWORD') ?: false;

# Samba mode
# true: update sambaNTpassword and sambaPwdLastSet attributes too
# false: just update the password
$samba_mode = getenv('SAMBA_MODE') ?: false;
...
$shadow_options['update_shadowLastChange'] = getenv('SHADOW_OPTIONS_UPDATE_SHADOWLASTCHANGE') ?: false;
$shadow_options['update_shadowExpire'] = getenv('SHADOW_OPTIONS_UPDATE_SHADOWEXPIRE') ?: false;

# Default to -1, never expire
$shadow_options['shadow_expire_days'] = getenv('SHADOW_OPTIONS_EXPIRE_DAYS') ?: -1;
...
$pwd_no_reuse = getenv('PWD_NO_REUSE') ?: true;
# Check that password is different than login
$pwd_diff_login = getenv('PWD_DIFF_LOGIN') ?: true;
# Complexity: number of different class of character required
$pwd_complexity = getenv('PWD_COMPLEXITY') ?: 0;
# use pwnedpasswords api v2 to securely check if the password has been on a leak
$use_pwnedpasswords = getenv('USE_PWNEDPASSWORDS') ?: false;
...
$use_change = getenv('USE_CHANGE') ?: true;

## SSH Key Change
# Allow changing of sshPublicKey?
$change_sshkey = getenv('CHANGE_SSHKEY') ?: false;
...
$notify_on_sshkey_change = getenv('NOTIFY_ON_SSHKEY_CHANGE') ?: false;

## Questions/answers
# Use questions/answers?
# true (default)
# false
$use_questions = getenv('USE_QUESTIONS') ?: true;

# Answer attribute should be hidden to users!
$answer_objectClass = getenv('ANSWER_OBJECTCLASS') ?: "extensibleObject";
$answer_attribute = getenv('ANSWED_ATTRIBUTE') ?: "info";

# Crypt answers inside the directory
$crypt_answers = getenv('CRYPT_ANSWERS') ?: true;
...
# true (default)
# false
$use_tokens = getenv('USE_TOKENS') ?: true;
# Crypt tokens?
# true (default)
# false
$crypt_tokens = getenv('CRYPT_TOKENS') ?: true;
...
# default = false
$mail_address_use_ldap = getenv('MAIL_ADDRESS_USE_LDAP') ?: false;
...
$mail_smtp_keepalive = getenv('MAIL_SMTP_KEEPALIVE') ?: false;
$mail_smtp_secure = getenv('MAIL_SMTP_SECURE') ?: 'tls';
$mail_smtp_autotls = getenv('MAIL_SMTP_AUTOTLS') ?: true;
...
$sms_partially_hide_number = getenv('SMS_PARTIALLY_HIDE_NUMBER') ?: true;
...
$sms_sanitize_number = getenv('SMS_SANITIZE_NUMBER') ?: false;
# Truncate GSM number
$sms_truncate_number = getenv('SMS_TRUNCATE_NUMBER') ?: false;
...
$show_help = getenv('SHOW_HELP') ?: true;
...
# Display menu on top
$show_menu = getenv('SHOW_MENU') ?: true;
...
$use_recaptcha = getenv('USE_RECAPTCHA') ?: false;
